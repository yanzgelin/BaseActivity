package com.example.administrator.baseactivty.widget;
...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CountDowntimeView);
        backgroundColor = ta.getColor(R.styleable.CountDowntimeView_background_colortime, BACKGROUND_COLOR);
        borderWidth = ta.getDimension(R.styleable.CountDowntimeView_border_widthtime, BORDER_WIDTH);
        borderColor = ta.getColor(R.styleable.CountDowntimeView_border_colortime, BORDER_COLOR);
        text = ta.getString(R.styleable.CountDowntimeView_texttime);
        if (text == null) {
            text = TEXT;
        }
        textSize = ta.getDimension(R.styleable.CountDowntimeView_text_sizetime, TEXT_SIZE);
        textColor = ta.getColor(R.styleable.CountDowntimeView_text_colortime, TEXT_COLOR);
        ta.recycle();
        init();
    }
